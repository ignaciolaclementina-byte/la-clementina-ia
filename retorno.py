...
st.markdown("<div style='text-align:center;'><h1 style='font-size: 50px;'>🚛 RETORNO MATCH</h1><p style='font-size: 20px;'>LOGÍSTICA SAN JORGE</p></div>", unsafe_allow_html=True)
    ...
    with c1:
        ...
        with st.form("f1", clear_on_submit=True):
            ...
            if st.form_submit_button("PUBLICAR"):
                ...
                st.success("En línea"); time.sleep(1); st.rerun()
    with c2:
