...
# --- DEFINICIÓN DE TABS (Esto arregla el error que tuviste) ---
...
with tab_chofer:
    ...
    with col_d:
        ...
        try:
            df_c = pd.read_csv(f"https://docs.google.com/spreadsheets/d/{SHEET_ID}/export?format=csv&gid={GID_CARGAS}").fillna("-")
...
# ==========================================
# PESTAÑA 2: SOY EMPRESA (INFO DETALLADA)
# ==========================================
with tab_empresa:
    ...
    with col_b:
        ...
        try:
            ...
            for _, r in df_h.iloc[::-1].iterrows():
                ...
                # r[8] es la columna 'ESTADO' en tu Excel
                ...
                <div class="card-white" style="border-left-color: {color_b};">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; font-size: 14px;">
                        ...
                        <div>🆔 <b>CUIT:</b><br>{r[5]}</div>
                        <div>💳 <b>LINTI:</b><br>{r[6]}</div>
                    </div>
                    
                    <div style="display:flex; gap:10px; margin-top: 20px;">
                        <a href="https://api.whatsapp.com/send?phone=549{r[4]}" target="_blank" class="btn-wsp" style="flex:2;">💬 HABLAR</a>
