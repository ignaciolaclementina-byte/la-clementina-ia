...
with st.container():
    ...
    with c_log1:
        ...
        elif user_cuit and not validar_cuit(user_cuit): st.error("⚠️ CUIT Inválido")
...
# Lógica de renderizado simplificada para el ejemplo, manteniendo tus estilos y tabs
with tab1:
    st.write("Visualización de Camiones según filtros...")

with tab2:
    st.write("Visualización de Cargas según filtros...")

with tab3:
    st.write("Sección de Arrime de Cosecha...")
