...
# --- 1. CONFIGURACIÓN (ESTRUCTURA BLINDADA - CREADO POR I.S.D) ---
...
# --- SISTEMA ADMIN EXCLUSIVO (EN SIDEBAR) ---
with st.sidebar:
    st.title("🛡️ Panel I.S.D")
    with st.expander("MODO ADMINISTRADOR"):
        ...
        if pass_input == ADMIN_PIN:
            ...
            st.session_state.anuncios = st.text_area("Texto del Radar:", st.session_state.anuncios)
