...
# 2. ESTILO VISUAL (CORREGIDO PARA MEJOR LECTURA)
st.markdown("""
    <style>
...
# El cargador de fotos que ya manejás bien
...
if foto:
    ...
    if st.button("🚀 INICIAR ANÁLISIS"):
        with st.spinner("Conectando con el Ingeniero IA..."):
            try:
                # SOLUCIÓN AL 404: Configuración directa sin v1beta
                ...
                # Generar respuesta (Corregido el error de corchetes)
